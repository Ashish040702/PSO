...
from pso_graph import *
from pso_particle import *


class PSO:
    def __init__(self, graph, iterations, size_population=5, beta=1, alpha=1):
        self.graph = graph
    ...
    def show_particles(self):
        ...
        for particle in self.particles:
            print(
                "particle:%d - pbest: %s\t|\tcost pbest: %d\t|\tcurrent soln: %s\t|\tcost soln: %d"
                % (
                    pindex,
                    str(particle.get_pbest()),
                    particle.get_cost_pbest(),
                    str(particle.get_current_solution()),
            ...
            for particle in self.particles:
                ...
                for i in range(self.graph.amount_vertices):
                    if solution_particle[i] != solution_pbest[i]:
                        ...
                        swap_operator = (
                            i,
                            solution_pbest.index(solution_particle[i]),
                            self.alpha,
                        )
                        ...
                        solution_pbest[swap_operator[0]] = solution_pbest[
                            swap_operator[1]
                        ]
                ...
                for i in range(self.graph.amount_vertices):
                    if solution_particle[i] != solution_gbest[i]:
                        ...
                        swap_operator = (
                            i,
                            solution_gbest.index(solution_particle[i]),
                            self.beta,
                        )
                        ...
                        solution_gbest[swap_operator[0]] = solution_gbest[
                            swap_operator[1]
                        ]
                ...
                for swap_operator in temp_velocity:
                    if random.random() <= swap_operator[2]:
                        ...
                        solution_particle[swap_operator[0]] = solution_particle[
                            swap_operator[1]
                        ]
